...
$cabeceras .= 'To: Taller de torno <torno@example.com>' . "\r\n";
$cabeceras .= 'From: Contacto web <user@example.com>' . "\r\n";

// Enviarlo

if (mail('estebane03597@gmail.com', 'Contacto Pagina web', $htmlBody, $cabeceras))
	echo "1";
else
	echo "0";
?>